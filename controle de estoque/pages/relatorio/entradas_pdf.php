...
$pdf->Cell(190,10,utf8_decode("Relatório de Entradas"),0,0,"C");
$pdf->Ln(15);
...
foreach($produtos as $prod){
    ...
    $pdf->Cell(14,7,utf8_decode($prod['data_entrada']),1,0,"C");
    $pdf->Cell(12,7,utf8_decode($prod['hora_entrada']),1,0,"C");
    $pdf->Ln();
}
